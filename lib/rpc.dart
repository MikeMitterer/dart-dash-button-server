...
class Dash {
    ...
    ToyResponse helloNamePostAge(String name, ToyAgeRequest request) {
        ...
        return new ToyResponse()
            ..result = 'Hello ${name} of age ${request.age}!';
    }

    @ApiMethod(path: 'helloNestedMap')
    ToyMapResponse helloNestedMap() {
        var map = {
            'bar': new NestedResponse()
                ..nestedResult = 'somethingNested',
            'var': new NestedResponse()
                ..nestedResult = 'someotherNested'
        };
    ...
    ToyResponse helloNameQueryAgeFoo(String name, {String foo, int age}) {
        return new ToyResponse()
            ..result = 'Hello $name of age $age with $foo!';
    }
    ...
    Map<String, Map<String, bool>> helloNestedMapMap(Map<String, Map<String, int>> request) {
        return null;
    }
    ...
    Map<String, List<Map<String, bool>>> helloNestedMapListMap(Map<String, List<Map<String, int>>> request) {
        return null;
    }

    @ApiMethod(path: 'helloNestedListMapList', method: 'POST')
    List<Map<String, List<String>>> helloNestedListMapList(List<Map<String, List<int>>> request) {
        return null;
    }
    ...
    Map<String, ToyResponse> helloListOfClass(List<ToyRequest> request) {
        ...
        return {key: new ToyResponse()
            ..result = value.toString()};
    }

    @ApiMethod(path: 'helloListOfListOfClass', method: 'POST')
    Map<String, ToyResponse> helloListOfListOfClass(List<List<ToyRequest>> request) {
        var key, value;
        if (request == null || request.isEmpty ||
